...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_rsp_mux_001.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_rsp_mux.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_rsp_demux_002.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_rsp_demux.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_cmd_mux_002.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_cmd_mux.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_cmd_demux_001.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_cmd_demux.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_router_004.sv \
