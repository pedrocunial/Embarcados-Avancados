...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/Dados/opt/intelFPGA/17.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/hps_only_master_master_cmd_width_adapter/
mkdir -p ./libraries/hps_0_f2h_axi_slave_wr_burst_adapter/
mkdir -p ./libraries/alt_vip_vfr_hdmi_avalon_master_limiter/
mkdir -p ./libraries/hps_0_f2h_axi_slave_agent/
mkdir -p ./libraries/alt_vip_vfr_hdmi_avalon_master_agent/
mkdir -p ./libraries/alt_vip_vfr_hdmi_avalon_master_translator/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_rsp_mux_001.sv"                              -work rsp_mux_001                               -cdslib ./cds_libs/rsp_mux_001.cds.lib                              
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                              -work rsp_mux                                   -cdslib ./cds_libs/rsp_mux.cds.lib                                  
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_rsp_demux_002.sv"                            -work rsp_demux_002                             -cdslib ./cds_libs/rsp_demux_002.cds.lib                            
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_cmd_mux_002.sv"                              -work cmd_mux_002                               -cdslib ./cds_libs/cmd_mux_002.cds.lib                              
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                              -work cmd_mux                                   -cdslib ./cds_libs/cmd_mux.cds.lib                                  
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_cmd_demux_001.sv"                            -work cmd_demux_001                             -cdslib ./cds_libs/cmd_demux_001.cds.lib                            
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_router_004.sv"                               -work router_004                                -cdslib ./cds_libs/router_004.cds.lib                               
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_width_adapter.sv"                                           -work hps_only_master_master_cmd_width_adapter  -cdslib ./cds_libs/hps_only_master_master_cmd_width_adapter.cds.lib 
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                       -work hps_only_master_master_cmd_width_adapter  -cdslib ./cds_libs/hps_only_master_master_cmd_width_adapter.cds.lib 
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                      -work hps_only_master_master_cmd_width_adapter  -cdslib ./cds_libs/hps_only_master_master_cmd_width_adapter.cds.lib 
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"                                         -work alt_vip_vfr_hdmi_avalon_master_limiter    -cdslib ./cds_libs/alt_vip_vfr_hdmi_avalon_master_limiter.cds.lib   
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"                                          -work alt_vip_vfr_hdmi_avalon_master_limiter    -cdslib ./cds_libs/alt_vip_vfr_hdmi_avalon_master_limiter.cds.lib   
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                  -work alt_vip_vfr_hdmi_avalon_master_limiter    -cdslib ./cds_libs/alt_vip_vfr_hdmi_avalon_master_limiter.cds.lib   
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                         -work alt_vip_vfr_hdmi_avalon_master_limiter    -cdslib ./cds_libs/alt_vip_vfr_hdmi_avalon_master_limiter.cds.lib   
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                            -work alt_vip_vfr_hdmi_avalon_master_agent      -cdslib ./cds_libs/alt_vip_vfr_hdmi_avalon_master_agent.cds.lib     
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                                       -work alt_vip_vfr_hdmi_avalon_master_translator -cdslib ./cds_libs/alt_vip_vfr_hdmi_avalon_master_translator.cds.lib
